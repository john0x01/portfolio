...
export default function Page() {
  const words = ['full-stack', 'mobile', 'proactive']
    ...
    <main className="flex flex-col w-full relative overflow-x-hidden">
        ...
        <div className="w-full max-w-[1080px] px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex flex-col gap-6">
            <h1 className="text-h1 h-[180px] sm:h-[120px] md:h-[272px] lg:h-[204px]">
              Hello! I am a <FlipWords words={words} /> <br /> developer
            </h1>
            <Animate fromY={40} duration={0.25}>
              <div className="flex items-center gap-4">
                ...
                <p className="md:text-lg opacity-80">
                  My name is João Rocha and I can help your company to grow with
                  software.
                </p>
              </div>
            </Animate>
      ...
      >
        <div className="flex w-full max-w-7xl flex-col gap-16 items-center px-4 py-8 sm:py-16">
          ...
          <Animate direction="right" className="mr-auto">
            <h2 className="text-h3">Main technologies</h2>
          </Animate>
      ...
      >
        <div className="w-full max-w-7xl px-4 py-8 sm:py-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-6">
            <Animate direction="left" duration={0.25}>
              <h1 className="text-h2 z-50">About me</h1>
            </Animate>
            <Animate direction="left" duration={0.5} fromX={1}>
              <p className="text-sm md:text-base opacity-80">
                I am a programmer and enthusiast of technology, marketing and
                entrepreneurship. I worked for the last two years as programmer,
                the first being a Front-end Developer and the Second, expanding
                my knowledge as a Developer Full stack. I worked for over a year
                in a startup of mine city and today I work as a freelancer,
                delivering Great results and improving myself every day. My
                specialty includes React, NextJS, Node, Typescript, React Native
                and SQL.
              </p>
            </Animate>
            <Animate direction="left" duration={0.5} fromX={1}>
              <p className="text-sm md:text-base opacity-80">
                In addition to conventional work, I am also investing in
                creation of content in the tech area on Instagram and YouTube,
                in order to add value to people’s lives and train more
          ...
          <Animate className="w-full">
            <div className="flex w-full max-w-[1080px] mx-auto flex-col items-center gap-12 md:gap-16 p-8 md:py-16 rounded-2xl border border-white/15 relative overflow-hidden">
              ...
              <div className="flex flex-col gap-4 items-center">
                <ContactFormTrigger>
                  <Button>🔥 I want to hire you now</Button>
                </ContactFormTrigger>
              </div>
            </div>
          </Animate>
