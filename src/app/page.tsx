          ...
          <Animate className="w-full">
            <div className="flex w-full max-w-[1080px] mx-auto flex-col items-center gap-12 md:gap-16 p-8 md:py-16 rounded-2xl border border-white/15 relative overflow-hidden">
              ...
              <p className="text-sm md:text-base opacity-80 text-center">
                De designs e prototipação de wireframes até o desenvolvimento de
                aplicações de grande porte, minha especialidade é entregar
                resultados e agregar valor com cada linha de código que eu
                escrevo. Estou interessado em utilizar minhas habilidades em
                trabalhos fixos e contratos de freelance, o resultado eu
                garanto. Entre em contato para construirmos seu próximo SaaS,
                Aplicativo ou site.
              </p>
